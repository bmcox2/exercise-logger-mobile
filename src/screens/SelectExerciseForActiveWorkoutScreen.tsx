...
import { ActiveWorkoutStackParamList, ExerciseLibraryRow } from "../types";
import { searchExerciseLibraryByName } from "../db/database";

type Props = NativeStackScreenProps<
  ActiveWorkoutStackParamList,
  "SelectExerciseForActiveWorkout"
>;

export default function SelectExerciseForActiveWorkoutScreen({
  navigation,
  route,
}: Props) {
